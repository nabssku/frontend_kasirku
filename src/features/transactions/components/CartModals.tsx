import { X, Clock, Store, ChefHat, Bike, Table2, User, ChevronDown, CreditCard, Building2, CheckCircle2, AlertCircle } from 'lucide-react';
...
export const OrderModal = ({
    ...
    customerId, setCustomerId, customersData, discount, setDiscount, notes, setNotes
}: OrderModalProps) => {
    if (!isOpen) return null;
        ...
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-md flex items-center justify-center z-[110] p-4 animate-in fade-in duration-300 text-left">
            <div className="bg-white rounded-[32px] shadow-2xl w-full max-w-lg overflow-hidden animate-in zoom-in-95 duration-300">
                <div className="p-8 border-b border-slate-100 flex items-center justify-between bg-gradient-to-r from-white to-slate-50">
                    ...
                    <button onClick={onClose} className="w-10 h-10 flex items-center justify-center bg-slate-100 hover:bg-red-50 text-slate-400 hover:text-red-500 rounded-full transition-all">
                        ...
                        <div className="space-y-3 animate-in slide-in-from-top-4 duration-500 text-left">
                            ...
                            <div className="relative group">
                                ...
                                <select
                                    ...
                                    className="w-full pl-12 pr-10 py-4 rounded-2xl border border-slate-200 text-sm font-bold bg-slate-50/50 group-hover:bg-white focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 outline-none transition-all appearance-none shadow-sm text-slate-700"
                                >
                    ...
                    <div className="grid grid-cols-2 gap-6 text-left">
                        <div className="space-y-3 col-span-2">
                            ...
                            <div className="relative group">
                                <select
                                    ...
                                    className="w-full h-14 pl-4 pr-10 rounded-2xl border border-slate-200 text-sm font-bold bg-slate-50/50 group-hover:bg-white focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 outline-none transition-all appearance-none text-slate-700 shadow-sm"
                                >
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="w-full h-14 pl-10 pr-4 rounded-2xl border border-slate-200 text-sm font-bold bg-slate-50/50 group-hover:bg-white focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 outline-none transition-all text-slate-700 placeholder:text-slate-300 shadow-sm"
                                    placeholder="0"
                                />
                            </div>
                        </div>
                        ...
                        <div className="space-y-3">
                            ...
                            <input
                                ...
                                className="w-full h-14 px-4 rounded-2xl border border-slate-200 text-sm font-bold bg-slate-50/50 hover:bg-white focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 outline-none transition-all text-slate-700 placeholder:text-slate-300 shadow-sm"
